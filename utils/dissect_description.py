...
def dissect_description(description: str):
    ...
    if has_html_linebreaks:
        ...
        while idx_description_line_current < len(description_lines):
            line = description_lines[idx_description_line_current]
            if len(line) <= 5:
                ...
                if len(additional_info) > len('Additional Information:') + 5:
                    ...
                    # Case 2: Additional Information is on the line following "Additional Information" Title
                    idx_additional_info = idx_description_line_current + 1
                    additional_info = description_lines[idx_additional_info]
                    while len(additional_info) < 5:
                    ...
                    additional_info = None
                    break
            idx_description_line_current += 1
        if has_demos:
